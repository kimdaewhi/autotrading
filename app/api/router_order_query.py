...
# ⚙️ 특정 종목 주문지 조회
@router.get("/domestic-stock/order-list/{stock_code}", response_model=list[OrderRead])
...
# ⚙️ 특정 상태 주문지 조회
@router.get("/domestic-stock/order-list/status/{status}", response_model=list[OrderRead])
...
# ⚙️ 특정 주문 방향 주문지 조회
@router.get("/domestic-stock/order-list/order-action/{order_action}", response_model=list[OrderRead])
