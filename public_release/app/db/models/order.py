...
class Order(Base):
    ...
    order_pos: Mapped[str] = mapped_column(String(8), nullable=False)          # BUY / SELL
    order_kind: Mapped[str] = mapped_column(                                   # NEW / MODIFY / CANCEL
        String(16),
        nullable=False,
        default="NEW",
        server_default="NEW",
    ...
    original_broker_order_no: Mapped[str | None] = mapped_column(String(32), nullable=True)
    original_broker_org_no: Mapped[str | None] = mapped_column(String(16), nullable=True)
